...
export const COMPANY_NAME = "Penn Air Repair LLC";
export const COMPANY_NAME_CAPS = "PENN AIR REPAIR LLC";
export const COMPANY_NICKNAME = "Penn air";
